...
console.log('Main module loaded - initializing application');

// Try-catch wrapper around initialization to catch any early errors
try {
  // Login component
  ...
  // Log before DOM rendering
  console.log('Starting to render App to DOM');
  ...
  if (rootElement) {
    rootElement.innerHTML = `
      <div style="padding: 20px; text-align: center; font-family: sans-serif;">
        ...
        <div style="color: red; margin: 20px; padding: 10px; background: #fff1f0; border: 1px solid #ffa39e; border-radius: 4px; text-align: left;">
          <p><strong>Error:</strong> ${error instanceof Error ? error.message : String(error)}</p>
        </div>
        <button onclick="window.location.reload()" style="padding: 8px 16px; background: #8b5cf6; color: white; border: none; border-radius: 4px; cursor: pointer;">
          Reload Page
        </button>
      </div>
    `;
